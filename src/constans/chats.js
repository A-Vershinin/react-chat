...
export const CREATE_CHAT_REQUEST = Symbol('chats/FETCH_CHAT_REQUEST');
export const CREATE_CHAT_SUCCESS = Symbol('chats/FETCH_CHAT_SUCCESS');
export const CREATE_CHAT_FAILURE = Symbol('chats/FETCH_CHAT_FAILURE');

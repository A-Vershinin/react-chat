...
export const RESIEVE_AUTH_REQUEST = Symbol('auth/RESIEVE_AUTH_REQUEST');
export const RESIEVE_AUTH_SUCCESS = Symbol('auth/RESIEVE_AUTH_SUCCESS');
export const RESIEVE_AUTH_FAILURE = Symbol('auth/RESIEVE_AUTH_FAILURE');

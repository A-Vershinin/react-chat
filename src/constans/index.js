...
export const RESIEVE_AUTH_REQUEST = Symbol('RESIEVE_AUTH_REQUEST');
export const RESIEVE_AUTH_SUCCESS = Symbol('RESIEVE_AUTH_SUCCESS');
export const RESIEVE_AUTH_FAILURE = Symbol('RESIEVE_AUTH_FAILURE');
